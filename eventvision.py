...
#             resized_img = cv2.resize(img, (340,340))
#             cv2.imshow('img', resized_img.astype(np.uint8))
...
#     def show_td(self, wait_delay=100):
...
#                 resized_img = cv2.resize(td_img, (340,340))
#                 cv2.imshow('img', resized_img.astype(np.uint8))
#                 cv2.waitKey(wait_delay)
